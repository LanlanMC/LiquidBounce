...
<div class="setting">
    ...
    {#if expanded}
        <div class="choices" transition:slide|global={{duration: 83, axis: "y"}}>
...
<style lang="scss">
  ...
  .choice {
    ...
    cursor: pointer;
    font-weight: 500;
    transition: ease color 0.083s, ease background-color 0.083s;
    ...
    .choice-action {
      ...
      padding: 1px 2px;
      border-radius: 2px;
      transition: ease color 0.083s, ease background-color 0.083s, ease width 0.083s, ease opacity 0.083s;
      display: inline-flex;
      align-items: center;
  ...
  .head {
    ...
    transition: ease margin-bottom .083s;
    align-items: center;
