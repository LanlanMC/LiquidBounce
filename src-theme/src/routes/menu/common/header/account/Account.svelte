...
<div class="account" class:expanded bind:this={accountElement} on:click={handleSelectClick}>
    <div class="header" bind:this={headerElement}>
        {#if $isLoggingIn}
            <div class="avatar-wrapper" transition:fade={{ duration: 83 }}>
        ...
        {:else}
            <div class="avatar-wrapper">
                ...
                {#if isAnniversary() && inTitle}
                    <img transition:fly={{duration: 233, y: -10}} class="party-hat" src="img/anniversary/party-hat.svg" alt="party-hat">
                {/if}
            </div>
        {/if}
